...
export class TextFieldBasicExample extends React.Component<IPCFContextProps, IDetailsListBasicExampleState> {
          ...
          <Stack horizontal tokens={itemAlignmentsStackTokens}>
            <Stack>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceId">Device ID</Label><TextField value={deviceId} onChange={e => this.setDeviceId(e)} styles={textFieldItemStyles} id="deviceId" /></Stack>
              </Stack.Item>
              <Stack.Item align="start" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceType">Type</Label><TextField value={deviceType} onChange={e => this.setDeviceType(e)} styles={textFieldItemStyles} id="deviceType" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceModel">Model</Label><TextField value={deviceModel} onChange={e => this.setDeviceModel(e)} styles={textFieldItemStyles} id="deviceModel" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceStatus">Status</Label><Dropdown selectedKey={deviceStatus} onChange={(e, option, index) => this.setDeviceStatus(e, option, index)} options={this.statusOptions} styles={textFieldItemStyles} id="deviceStatus" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceUnitAddress">Unit Address</Label><TextField value={deviceUnitAddress} onChange={e => this.setDeviceUnitAddress(e)} styles={textFieldItemStyles} id="deviceUnitAddress" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceHeadendName">Headend Name</Label><TextField value={deviceHeadendName} onChange={e => this.setDeviceHeadendName(e)} styles={textFieldItemStyles} id="deviceHeadendName" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceNetworkCode">Network Code</Label><TextField value={deviceNetworkCode} onChange={e => this.setDeviceNetworkCode(e)} styles={textFieldItemStyles} id="deviceNetworkCode" /></Stack>
              </Stack.Item>
            </Stack>
            <Stack>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceLocationId">Location ID</Label><TextField value={deviceLocationId} onChange={e => this.setDeviceLocationId(e)} styles={textFieldItemStyles} id="deviceLocationId" /></Stack>
              </Stack.Item>
              <Stack.Item align="start" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceAddress1">Address 1</Label><TextField value={deviceAddress1} onChange={e => this.setDeviceAddress1(e)} styles={textFieldItemStyles} id="deviceAddress1" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceAddress2">Address 2</Label><TextField value={deviceAddress2} onChange={e => this.setDeviceAddress2(e)} styles={textFieldItemStyles} id="deviceAddress2" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceCity">City</Label><TextField value={deviceCity} onChange={e => this.setDeviceCity(e)} styles={textFieldItemStyles} id="deviceCity" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceState">State</Label><TextField value={deviceState} onChange={e => this.setDeviceState(e)} styles={textFieldItemStyles} id="deviceState" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceZip">ZIP</Label><TextField value={deviceZip} onChange={e => this.setDeviceZip(e)} styles={textFieldItemStyles} id="deviceZip" /></Stack>
              </Stack.Item>
              <Stack.Item align="baseline" styles={stackItemStyles}>
                <Stack horizontal><Label styles={labelItemStyles} htmlFor="deviceComment">Comment</Label><TextField value={deviceComment} onChange={e => this.setDeviceComment(e)} styles={textFieldItemStyles} id="deviceComment" /></Stack>
              </Stack.Item>
            </Stack>
          </Stack>
          <Stack horizontal>
            <Stack.Item align="baseline" styles={stackButtonsItemStyles}>
              <span><PrimaryButton onClick={e => this.performSearch(e)}>Perform Search</PrimaryButton></span>
            </Stack.Item>
            <Stack.Item align="baseline" styles={stackButtonsItemStyles}>
              <span><PrimaryButton onClick={e => this.resetFilters(e)}>Reset Filters</PrimaryButton></span>
            </Stack.Item>
            <Stack.Item align="baseline" styles={stackButtonsItemStyles}>
              <span><PrimaryButton onClick={e => this.closeAdvFind(e)}>Close Adv Find</PrimaryButton></span>
            </Stack.Item>
          </Stack>
